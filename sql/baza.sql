...
-- Izrada baze podataka i tablice za portal Glasnik

CREATE DATABASE IF NOT EXISTS glasnik
...
INSERT INTO vijesti (naslov, sazetak, tekst, kategorija, oznake, slika, prikazi, datum) VALUES

('Kako boljim govorom tijela postižete više uspjeha',
 'Samopouzdano držanje često je vrjednije od izgleda. Otkrivamo nekoliko jednostavnih trikova kojima možete poboljšati govor tijela na poslovnim sastancima, razgovorima za posao i u svakodnevnoj komunikaciji.',
 'Prvi dojam stvara se u prvih nekoliko sekundi susreta, i to najčešće prije nego što izgovorimo i jednu riječ. Način na koji ulazimo u prostoriju, kako stojimo i gledamo sugovornika govori više o našem samopouzdanju nego što mislimo, a istraživanja pokazuju da neverbalna komunikacija često ostavlja dublji trag od samih riječi.
...
Govor tijela, kao i svaka druga vještina, poboljšava se vježbom. Snimanje vlastitih nastupa na telefon ili vježbanje pred ogledalom prije važnih razgovora pomaže da uočimo navike kojih nismo svjesni - od nervoznog dodirivanja lica do prebrzog govora - i postupno ih ispravimo.',
 'Posao i karijera',
 'Karijera,Savjeti',
 'slike/govor-tijela.jpg',
 1,
 '2026-05-13'),

('Totalna kontrola – kada aplikacija određuje vaš slobodan dan',
 'Sve više tvrtki uvodi aplikacije za praćenje radnog vremena zaposlenika. Tehnologija za to postoji, ali otvara brojna pitanja o privatnosti i granici između posla i slobodnog vremena.',
 'Sve veći broj poslodavaca razmišlja o uvođenju mobilnih i računalnih aplikacija koje bi automatski bilježile dolazak, odlazak i stanke zaposlenika. Ideja zvuči jednostavno, no posljedice za svakodnevni rad i privatnost zaposlenika mogu biti dalekosežne.
...
Rasprava o granicama digitalnog nadzora na radnom mjestu vjerojatno će se tek zaoštriti kako sve više tvrtki prelazi na rad od kuće i hibridne modele rada, gdje je granica između privatnog i radnog vremena sve teže povući.',
 'Posao i karijera',
 'Karijera,Tehnologija',
 'slike/ured-nocu.jpg',
 1,
 '2026-05-16'),

('Kako vaše dijete može upisati elitno sveučilište',
 'Upis na vrhunska svjetska sveučilišta postaje sve konkurentniji. Roditelji bi se trebali pripremiti unaprijed, a kandidati moraju u prijavi istaknuti tri ključne stvari.',
 'Sve veći broj srednjoškolaca i njihovih roditelja razmišlja o studiranju na nekom od svjetski poznatih sveučilišta. Broj prijava raste iz godine u godinu, dok broj slobodnih mjesta ostaje gotovo nepromijenjen, što natjecanje za upis čini izrazito zahtjevnim.
...
('Limunasta piletina iz pećnice',
 'Miris koji se širi kuhinjom već je sam po sebi nagrada. Otkrijte jednostavan recept za sočnu piletinu iz pećnice koji uspijeva i početnicima u kuhanju.',
 'Cijela piletina pečena s limunom, češnjakom i svježim začinskim biljem jedno je od onih jela koja djeluju impresivno na stolu, a u pripremi su iznenađujuće jednostavna - savršeno za nedjeljni ručak ili objed s gostima.
...
Prije rezanja piletinu je dobro ostaviti da odstoji desetak minuta, kako bi meso ostalo sočno, a kao prilog dovoljan je samo zeleni list salate, jer je krumpir pečen uz piletinu već upio sve okuse iz pleha.',
 'Hrana',
 'Recepti',
 'slike/piletina-limun.jpg',
 1,
 '2026-05-16'),

('Nije dovoljno ljuto? Umaci koje morate probati',
 'Za marinade, kuhanje ili samo začinjavanje – predstavljamo pet ljutih umaka kojima ćete osvježiti svoju kuhinju i podići okus svakog jela.',
 'Za marinade, kuhanje ili samo začinjavanje gotovog jela - ljuti umak ima čarobnu moć da svaki, i naizgled najobičniji obrok, podigne na novu razinu. U nastavku predstavljamo pet umaka koji se razlikuju po profilu okusa, intenzitetu i podrijetlu.
...
Bez obzira na to koji umak odaberete, isplati se krenuti s malom količinom i postupno dodavati, jer se intenzitet ljutine razlikuje ne samo među umacima, nego i među pojedinim serijama istog proizvoda.',
 'Hrana',
 'Recepti,Savjeti',
 'slike/ljuti-umaci.jpg',
 1,
 '2026-05-15'),

('Špageti all''ubriaco',
 'Ovo jelo živi od kombinacije tjestenine i vina. Kod špageta „na pijani način” crno vino dodaje se izravno u vodu za kuhanje, čime tjestenina dobiva prepoznatljivu boju i aromu.',
...
Dodavanjem nekoliko žlica sačuvane tekućine i ribanog parmezana stvara se lagana, blago kremasta tekstura, a jelo se poslužuje odmah, posipano svježim peršinom i dodatnim parmezanom. Za najbolji rezultat preporučuje se koristiti vino koje biste i sami popili uz jelo.',
 'Hrana',
 'Recepti',
 'slike/spageti-vino.jpg',
 1,
 '2026-05-14');